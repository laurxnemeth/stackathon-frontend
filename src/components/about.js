  ...
  return (
    <div>
      ...
      <p>
        ...
        the entire novel <a href="https://www.gutenberg.org/ebooks/514">here</a>{' '}
        or at your local{' '}
        <a href="https://www.worldcat.org/libraries">library</a>.
      </p>
      ...
      <p>
        ...
        and <a href="https://github.com/laurxnemeth/stackathon-backend">here</a>
        .
      </p>
      <h3>Will you add more books?</h3>
      <p>
        Yes! I’m open to suggestions (given that they are public domain, such as
        books found in{' '}
